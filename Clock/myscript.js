...
function tick(mc, i, toZero=false){
    //set numbers
    mc.childNodes[3].innerHTML = "<span>"+i+"</span>";
    mc.childNodes[5].innerHTML = "<span>"+i+"</span>";

    if(i==9 || toZero) i=-1;
    mc.childNodes[1].innerHTML = "<span>"+(i+1)+"</span>";
    mc.childNodes[7].innerHTML = "<span>"+(i+1)+"</span>";
